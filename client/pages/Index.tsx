      ...
      <section className="border-t bg-white/60 dark:bg-background/60">
        <div className="container py-10 lg:py-14 grid gap-10 lg:grid-cols-[1fr_300px]">
          ...
          <article className="prose prose-slate prose-a:text-[#c36] max-w-none dark:prose-invert">
            ...
            <p>Panchakarma has its roots deeply embedded in India's rich medical tradition, dating back 3,500 to 5,000 years. According to Hindu mythology, it traces back to Lord Brahma, the creator. The therapy is extensively documented in classical Ayurvedic texts:</p>
            <ul>
              <li><em>Charaka Samhita</em> (1st century AD) – The oldest existing Ayurvedic text</li>
              <li><em>Sushruta Samhita</em> – Focuses on surgical aspects</li>
              <li><em>Ashtanga Hridayam</em> – Compilation of both traditions</li>
            </ul>
            <p>These ancient texts provide detailed methodologies that remain applicable and effective today, emphasizing the importance of understanding the patient's mind, body, and soul when treating disease.</p>

            <h2 id="who-should-consider">3. Who Should Consider Panchakarma?</h2>
            ...
            <ul>
              ...
              <li>General feeling of being "not your best self" despite trying other solutions</li>
            </ul>
            <p>Panchakarma could be an excellent choice for you. It's suitable for individuals seeking a deeper approach to health rather than temporary relief.</p>
            <h3>Perfect for Modern Indian Lifestyle</h3>
            <p>In India's context, where fast food, late-night routines, and sedentary lifestyles are common, Panchakarma can help reset your health. Whether you're a college student dealing with study pressure, a working professional feeling burnt out, or a senior citizen managing age-related health issues—anyone seeking holistic healing, mental clarity, physical detox, and long-term wellness can benefit.</p>
            ...
            <ul>
              <li>Deepana &amp; Pachana: Digestive fire enhancement using herbs like Hingwashtak churna</li>
              <li>Snehana: Internal and external oleation with medicated oils/ghee</li>
              <li>Swedana: Therapeutic sweating to liquefy toxins</li>
            </ul>
            <p><strong>Purpose:</strong> Prepares the body for safe and effective main treatments by mobilizing deep-seated toxins.</p>
            <h3>Phase 2: Pradhana Karma (Main Procedures)</h3>
            <p><strong>Duration:</strong> 3–7 days. The actual elimination procedures (one or more of the five main treatments) are performed based on individual constitution and health conditions.</p>
            ...
            <ul>
              <li>Preventive healthcare – maintains health during seasonal changes</li>
              <li>Increased lifespan through cellular rejuvenation</li>
              <li>Enhanced drug efficacy when combined with other treatments</li>
              <li>Sustainable lifestyle changes supporting overall well-being</li>
            </ul>
            ...
            <ul>
              ...
              <li>Digestive: IBS, chronic constipation, acidity, poor appetite</li>
              <li>Musculoskeletal: Arthritis, joint pain, muscle stiffness, paralysis</li>
              <li>Neurological: Stress disorders, insomnia, migraine, depression</li>
              <li>Skin: Eczema, psoriasis, chronic skin conditions</li>
              <li>Metabolic: Diabetes, obesity, thyroid disorders</li>
              <li>Women's Health: Menstrual irregularities, fertility issues</li>
            </ul>
            ...
            <p><strong>Important Safety Measures:</strong> Always undergo treatment under qualified Ayurvedic physicians; complete medical history and constitution assessment are mandatory; proper preparation and post-treatment care are essential; avoid strenuous activities during treatment; follow dietary guidelines strictly.</p>

            <h2 id="duration-expectations">9. Duration and Expectations</h2>
            <h3>Treatment Duration Options</h3>
            <ul>
              <li>5 days: Basic detoxification (58.75% of patients choose this)</li>
            ...
            <p><strong>Immediate Effects (During Treatment):</strong> Increased elimination of toxins; temporary fatigue or emotional releases; changes in sleep patterns; improved appetite and digestion.</p>
            <p><strong>Short-term Benefits (1–4 weeks):</strong> Increased energy levels; better sleep quality; reduced stress and anxiety; improved skin complexion.</p>
            <p><strong>Long-term Results (3+ months):</strong> Complete improvement: 28%; Marked improvement: 22%; Moderate improvement: 21%; Mild improvement: 19%; No improvement: 10%.</p>

            <h2 id="choosing-practitioner">10. Choosing a Qualified Practitioner</h2>
            ...
            <p>Yes, when performed by qualified practitioners with proper assessment, Panchakarma is very safe. The therapy has been used successfully for thousands of years with minimal side effects when guidelines are followed.</p>
            <h3>How often should I undergo Panchakarma?</h3>
            <p>Traditionally recommended: Healthy individuals – once or twice yearly during seasonal transitions; chronic conditions – as advised by practitioner (may be more frequent initially); maintenance – annual treatments for preventive care.</p>
            <h3>Can I continue my regular medications?</h3>
            <p>Generally yes, but inform your Ayurvedic physician about all medications. Some medications may need timing adjustments, and the practitioner will coordinate with your primary physician if needed.</p>
            <h3>What should I expect during treatment?</h3>
            <p>Daily consultations and procedures; specific dietary guidelines; temporary lifestyle restrictions; possible healing reactions (fatigue, emotional releases); progressive improvement in energy and well-being.</p>
            <h3>Is the treatment expensive?</h3>
            <p>Costs vary based on duration and type of procedures, location and facility standards, and individual treatment requirements. Generally ranges from ₹15,000–₹50,000 for comprehensive programs.</p>
            <h3>Can I work during treatment?</h3>
            <p>Light work may be possible, but it's recommended to take time off for optimal results, avoid strenuous activities, allow for rest and recovery, and follow practitioner's specific guidelines.</p>

            <h2 id="resources">Resources and References</h2>
            <h3>Academic Sources</h3>
            <ol>
              <li>Singh, Nishant. "Panchakarma: Cleaning and Rejuvenation Therapy for Curing the Diseases." Journal of Pharmacognosy and Phytochemistry, Vol. 1 No. 2, 2012.</li>
              <li>Conboy LA, et al. "Ayurveda and Panchakarma: Measuring the Effects of a Holistic Health Intervention." PMC, 2009.</li>
              <li>Clinical Studies – Various peer-reviewed research available through PubMed and PMC databases</li>
            </ol>
            <h3>Professional Organizations</h3>
            <ul>
              <li>National Institute of Ayurveda, India</li>
              <li>Central Council for Research in Ayurveda and Siddha (CCRAS)</li>
              <li>World Health Organization – Traditional Medicine Program</li>
            </ul>
            <h3>Additional Reading</h3>
            <ul>
              <li>Classical Ayurvedic texts: Charaka Samhita, Sushruta Samhita</li>
          ...
          <aside className="lg:pl-8">
            <div className="sticky top-24 rounded-xl border bg-white/70 p-5 shadow-sm backdrop-blur dark:bg-background/60">
              <h4 className="text-sm font-semibold tracking-wide">Table of Contents</h4>
              <nav className="mt-3 text-sm space-y-1">
                <TOCItem href="#what-is-panchakarma" label="1. What is Panchakarma?" />
                <TOCItem href="#historical-background" label="2. Historical Background" />
                <TOCItem href="#who-should-consider" label="3. Who Should Consider Panchakarma?" />
                <TOCItem href="#five-procedures" label="4. The Five Main Procedures" />
                <TOCItem href="#treatment-phases" label="5. Three Phases of Treatment" />
                <TOCItem href="#health-benefits" label="6. Health Benefits" />
                <TOCItem href="#conditions-treated" label="7. Conditions Treated" />
                <TOCItem href="#contraindications" label="8. Contraindications & Precautions" />
                <TOCItem href="#duration-expectations" label="9. Duration & Expectations" />
                <TOCItem href="#choosing-practitioner" label="10. Choosing a Practitioner" />
                <TOCItem href="#scientific-research" label="11. Scientific Research" />
...
function TOCItem({ href, label }: { href: string; label: string }) {
  return (
    <a href={href} className="block rounded px-2 py-1 text-foreground/80 hover:bg-secondary hover:text-foreground">
      {label}
    </a>
  );
}
