      ...
      <div className="container flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Button asChild className="hidden sm:inline-flex">
            <Link to="/register" className="inline-flex items-center gap-2"><CalendarClock className="h-4 w-4"/>Register</Link>
          </Button>
        </div>
      </div>
      {location.pathname === "/" && (
        <div className="border-t bg-gradient-to-r from-primary/10 via-accent/10 to-primary/10">
          <div className="container py-2 text-xs sm:text-sm">
            <span className="font-semibold">for further queries contact us</span>: <a href="tel:+919876543210" className="underline decoration-dotted underline-offset-4 hover:text-primary">+91-98765 43210</a> • <a href="mailto:support@ayursutra.io" className="underline decoration-dotted underline-offset-4 hover:text-primary">support@ayursutra.io</a>
          </div>
        </div>
      )}
    </header>
